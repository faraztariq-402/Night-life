    ...
    var dt_category = dt_category_list_table.DataTable({
      ...
      columnDefs: [
        ...
        
        {
          ...
          orderable: false,
          render: function (data, type, full, meta) {
            var $cat_image = full['cat_image'];
            return "<div class='h6 mb-0 text-sm-end'>" + $cat_image + '</div';
          }
        },
      ...
      buttons: [
        {
          text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Units</span>',
